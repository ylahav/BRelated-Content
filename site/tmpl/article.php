...
<?php else: ?>
	<div class="b-related-content <?php if($article->type == "K2") echo "b-related-k2-content "; ?> ">
<?php endif; ?>
	...
	<?php if($params->get('readmore')) : ?>
		<div class="readmore"><a href="<?php echo $urls[$articleIndex]; ?>"> <?php echo JText::sprintf('MOD_B_RELATED_CONTENT_READMORE'); ?> </a></div>
	<?php endif; ?>
